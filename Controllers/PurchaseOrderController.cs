...
public class PurchaseOrderController : ControllerBase
{
    ...
    [ProducesResponseType(typeof(ApiResponse<PurchaseOrderResponseDto>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ApiResponse<object>), StatusCodes.Status404NotFound)]
    public async Task<IActionResult> GetByPurchaseRequestId(string purchaseRequestId, CancellationToken cancellationToken)
    {
    ...
    [ProducesResponseType(typeof(ApiResponse<object>), StatusCodes.Status404NotFound)]
    public async Task<IActionResult> GenerateFromPurchaseRequest(string purchaseRequestId, [FromBody] GeneratePurchaseOrderDto dto, CancellationToken cancellationToken)
    {
    ...
    [ProducesResponseType(typeof(ApiResponse<ValidationErrorData>), StatusCodes.Status400BadRequest)]
    [ProducesResponseType(typeof(ApiResponse<object>), StatusCodes.Status404NotFound)]
    public async Task<IActionResult> Update(string id, [FromBody] UpdatePurchaseOrderDto dto, CancellationToken cancellationToken)
    {
