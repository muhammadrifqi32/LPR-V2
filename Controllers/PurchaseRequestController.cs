...
public class PurchaseRequestController : ControllerBase
{
    ...
    [ProducesResponseType(typeof(ApiResponse<object>), StatusCodes.Status404NotFound)]
    public async Task<IActionResult> Submit(string id, [FromBody(EmptyBodyBehavior = Microsoft.AspNetCore.Mvc.ModelBinding.EmptyBodyBehavior.Allow)] SubmitPurchaseRequestDto? dto, CancellationToken cancellationToken)
    {
    ...
    [ProducesResponseType(typeof(ApiResponse<ValidationErrorData>), StatusCodes.Status400BadRequest)]
    [ProducesResponseType(typeof(ApiResponse<object>), StatusCodes.Status404NotFound)]
    public async Task<IActionResult> ApproveByGm(string id, [FromBody] ApprovalActionDto dto, CancellationToken cancellationToken)
    {
    ...
    [ProducesResponseType(typeof(ApiResponse<ValidationErrorData>), StatusCodes.Status400BadRequest)]
    [ProducesResponseType(typeof(ApiResponse<object>), StatusCodes.Status404NotFound)]
    public async Task<IActionResult> RejectByGm(string id, [FromBody] ApprovalActionDto dto, CancellationToken cancellationToken)
    {
    ...
    [ProducesResponseType(typeof(ApiResponse<ValidationErrorData>), StatusCodes.Status400BadRequest)]
    [ProducesResponseType(typeof(ApiResponse<object>), StatusCodes.Status404NotFound)]
    public async Task<IActionResult> RequestRevisionByGm(string id, [FromBody] ApprovalActionDto dto, CancellationToken cancellationToken)
    {
    ...
    [ProducesResponseType(typeof(ApiResponse<ValidationErrorData>), StatusCodes.Status400BadRequest)]
    [ProducesResponseType(typeof(ApiResponse<object>), StatusCodes.Status404NotFound)]
    public async Task<IActionResult> RecordChairmanApproval(string id, [FromBody] ChairmanConfirmationDto dto, CancellationToken cancellationToken)
    {
    ...
    [ProducesResponseType(typeof(ApiResponse<ValidationErrorData>), StatusCodes.Status400BadRequest)]
    [ProducesResponseType(typeof(ApiResponse<object>), StatusCodes.Status404NotFound)]
    public async Task<IActionResult> RecordChairmanRejection(string id, [FromBody] ChairmanConfirmationDto dto, CancellationToken cancellationToken)
    {
    ...
    [ProducesResponseType(typeof(ApiResponse<ValidationErrorData>), StatusCodes.Status400BadRequest)]
    [ProducesResponseType(typeof(ApiResponse<object>), StatusCodes.Status404NotFound)]
    public async Task<IActionResult> RecordChairmanRevision(string id, [FromBody] ChairmanConfirmationDto dto, CancellationToken cancellationToken)
    {
