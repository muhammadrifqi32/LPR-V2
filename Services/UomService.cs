...
public class UomService : IUomService
{
    ...
    public async Task<UomResponseDto> GetByIdAsync(string id, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<UomResponseDto> UpdateAsync(string id, UpdateUomDto dto, CancellationToken cancellationToken = default)
    {
        var entity = await _repository.QueryActive()
            .FirstOrDefaultAsync(x => x.UomId == id, cancellationToken);
