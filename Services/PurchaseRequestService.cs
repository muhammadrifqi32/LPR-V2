...
public class PurchaseRequestService : IPurchaseRequestService
{
    ...
    public async Task<PurchaseRequestResponseDto> GetByIdAsync(string id, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<SubmitResponseDto> SubmitAsync(string id, CancellationToken cancellationToken = default)
    {
        ...
        if (purchaseRequest.CreatedBy.IsPresent())
        {
            await AddActivityLogIfPossibleAsync(purchaseRequest.CreatedBy!, DocumentType.PURCHASE_REQUEST, purchaseRequest.PurchaseRequestId, "SUBMIT", "Purchase request submitted.", cancellationToken);
        }
