...
public class PurchaseRequestApprovalService : IPurchaseRequestApprovalService
{
    ...
    public async Task<SubmitResponseDto> SubmitAsync(string purchaseRequestId, SubmitPurchaseRequestDto? dto, CancellationToken cancellationToken = default)
    {
        ...
        var submittedBy = await ResolveActorAsync(dto?.SubmittedBy ?? string.Empty, purchaseRequest.CreatedBy, "SubmittedBy", cancellationToken);
    ...
    public Task<SubmitResponseDto> ApproveByGmAsync(string purchaseRequestId, ApprovalActionDto dto, CancellationToken cancellationToken = default)
    ...
    public Task<SubmitResponseDto> RejectByGmAsync(string purchaseRequestId, ApprovalActionDto dto, CancellationToken cancellationToken = default)
        => ProcessGmActionAsync(
            purchaseRequestId,
            dto,
    ...
    public Task<SubmitResponseDto> RequestRevisionByGmAsync(string purchaseRequestId, ApprovalActionDto dto, CancellationToken cancellationToken = default)
        => ProcessGmActionAsync(
            purchaseRequestId,
            dto,
    ...
    public Task<SubmitResponseDto> RecordChairmanApprovalAsync(string purchaseRequestId, ChairmanConfirmationDto dto, CancellationToken cancellationToken = default)
    ...
    public Task<SubmitResponseDto> RecordChairmanRejectionAsync(string purchaseRequestId, ChairmanConfirmationDto dto, CancellationToken cancellationToken = default)
        => ProcessChairmanActionAsync(
            purchaseRequestId,
            dto,
            targetStatusCandidates: ["REJECTED"],
    ...
    public Task<SubmitResponseDto> RecordChairmanRevisionAsync(string purchaseRequestId, ChairmanConfirmationDto dto, CancellationToken cancellationToken = default)
        => ProcessChairmanActionAsync(
            purchaseRequestId,
            dto,
            targetStatusCandidates: ["REVISION_REQUIRED"],
    ...
    public async Task<List<ApprovalHistoryResponseDto>> GetApprovalHistoryAsync(string purchaseRequestId, CancellationToken cancellationToken = default)
    {
    ...
    private async Task<PurchaseRequest> GetPurchaseRequestRequiredAsync(string purchaseRequestId, CancellationToken cancellationToken)
    {
        return await _purchaseRequestRepository.GetPurchaseRequestWithDetailsAsync(purchaseRequestId, cancellationToken)
            ?? throw new NotFoundException("Purchase Request not found");
    }

    private async Task<string> ResolveActorAsync(string providedActorId, string? fallbackActorId, string fieldName, CancellationToken cancellationToken)
    {
        var actorId = providedActorId.IsPresent() ? providedActorId : fallbackActorId;
        ...
        if (!exists)
            throw new ValidationException($"Account '{actorId}' does not exist.");
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (record is null)
        {
            ...
            {
                ApprovalRecordId = UlidHelper.NewUlid(),
