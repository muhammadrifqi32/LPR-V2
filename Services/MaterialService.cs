...
public class MaterialService : IMaterialService
{
    ...
    public async Task<MaterialResponseDto> GetByIdAsync(string id, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<MaterialResponseDto> UpdateAsync(string id, UpdateMaterialDto dto, CancellationToken cancellationToken = default)
    {
        var entity = await _repository.QueryActive()
            .Include(x => x.Uom)
            .FirstOrDefaultAsync(x => x.MaterialId == id, cancellationToken);
