...
public class RoleService : IRoleService
{
    ...
    public async Task<RoleResponseDto> GetByIdAsync(string id, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<RoleResponseDto> UpdateAsync(string id, UpdateRoleDto dto, CancellationToken cancellationToken = default)
    {
        var entity = await _repository.QueryActive()
            .FirstOrDefaultAsync(x => x.RoleId == id, cancellationToken);
