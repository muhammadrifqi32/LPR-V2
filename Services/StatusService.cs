...
public class StatusService : IStatusService
{
    ...
    public async Task<StatusResponseDto> GetByIdAsync(string id, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<StatusResponseDto> UpdateAsync(string id, UpdateStatusDto dto, CancellationToken cancellationToken = default)
    {
        var entity = await _repository.QueryActive()
            .FirstOrDefaultAsync(x => x.StatusId == id, cancellationToken);
