...
public class StatusLookupService : IStatusLookupService
{
    ...
    public async Task<bool> IsAnyAsync(string statusId, IEnumerable<string> statusNames, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<string?> GetNameAsync(string statusId, CancellationToken cancellationToken = default)
    {
        return await _statusRepository.QueryActive()
            .AsNoTracking()
