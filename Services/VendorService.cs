...
public class VendorService : IVendorService
{
    ...
    public async Task<VendorResponseDto> GetByIdAsync(string id, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<VendorResponseDto> UpdateAsync(string id, UpdateVendorDto dto, CancellationToken cancellationToken = default)
    {
        var entity = await _repository.QueryActive()
            .FirstOrDefaultAsync(x => x.VendorId == id, cancellationToken);
