...
public class CompanyService : ICompanyService
{
    ...
    public async Task<CompanyResponseDto> GetByIdAsync(string id, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<CompanyResponseDto> UpdateAsync(string id, UpdateCompanyDto dto, CancellationToken cancellationToken = default)
    {
        var entity = await _repository.QueryActive()
            .FirstOrDefaultAsync(x => x.CompanyId == id, cancellationToken);
